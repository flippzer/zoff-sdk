import type { AccountInfo, Contract, Holding, PreparedTransfer, PrepareTransferPayload, SubmitOptions, SubmitResult, SupportedNetwork, TransactionUpdate } from './types.js';
/**
...
export interface CantonWalletProvider {
     ...
     */
    submitTransaction(opts: SubmitOptions): Promise<{
